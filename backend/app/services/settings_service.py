...
class SettingsService:
    DEFAULTS={"general":{"language":"en","timezone":"UTC","theme":"dark","autostart":True},"telegram":{"api_id":None,"api_hash":None,"reconnect":True},"monitoring":{"check_interval":30,"realtime":True,"resync":True},"queue":{"max_tasks":1000,"parallel":1,"backoff_factor":2.0,"processing_timeout":300,"max_auto_retries":3},"limits":{"views_per_minute":10,"views_per_hour":200,"views_per_day":1500,"searches_per_hour":10,"search_results_max":50,"search_delay":300},"view":{"min_delay":20,"max_delay":120,"auto_like":False,"like_emoji":"👍"},"discovery":{"hashtags":[],"locations":[],"enabled":False},"filters":{"include_contacts":False,"include_unknown":True,"include_mutual_contacts":False,"include_non_mutual":True,"include_channels":True,"include_groups":True,"include_bots":True,"include_deleted":False,"include_blocked":False}}
